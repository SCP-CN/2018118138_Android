...
public class AddClock extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        requestCode = new Random().nextInt(50) + 0;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.save:
                    ...
                    Log.d("test","AddClock:" + content.getText().toString()+ " " + requestCode);

                    PendingIntent sender = PendingIntent.getBroadcast(
                            AddClock.this, requestCode++, intent, PendingIntent.FLAG_UPDATE_CURRENT);
                    AlarmManager am;
