...
import static com.example.dell.alarmalert.MainActivity.list;
import static com.example.dell.alarmalert.MainActivity.timeAdapter;
...
public class   ClockDetail extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        requestCode = new Random().nextInt(150) + 100;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.save:
                ...
                Log.d("test","ClockDetail:" + clock.getContent() + " " + requestCode);

                //sendBroadcast(intent);
                PendingIntent sender = PendingIntent.getBroadcast(
                        ClockDetail.this, requestCode++, intent, PendingIntent.FLAG_UPDATE_CURRENT);
                AlarmManager am;
